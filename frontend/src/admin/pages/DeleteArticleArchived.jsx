...
export default function DeleteArticleArchived() {
  ...
  return (
    <div className="adminPage">
      <h3>
        Supprimer des articles archivés&#x20;
        <FaInfoCircle
          size={16}
          title="Vous pouvez ici supprimer définitivement un ou plusieurs articles archivés."
        />
      </h3>
      <div>
